    ...
    <div class="container">
      ...
      <div class="leftAlign">
        ...
        <ul>
          ...
          <li><small><a href="">{{ $t('globalTitle') }}</a></small></li>
...
<script>
  ...
  import provincesUs, {preselectedProvinceUs} from '../assets/provincesUs';
  ...
  export default {
    ...
    data: () => ({
      compType: 'us',
      countries: provincesUs,
      storeChangeAction: 'changeProvinceUs'
    }),
  computed: {
    urlPrefix: {
      get: function() {
    ...
    preselected: {
      get: function () {
        return this.$store.state.provinceUs || preselectedProvinceUs;
      },
      set: function (newVal) {
        this.$store.dispatch('changeProvinceUs', newVal)
      }
    }
  }
  }
